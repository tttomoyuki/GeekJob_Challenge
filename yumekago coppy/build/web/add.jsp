<%-- 
    Document   : add
    Created on : 2017/11/20, 15:36:54
    Author     : taked
--%>
...
<html>
    ...
    <body>
        ...
        <form action="Search_" method="GET">
         ...
         <h3>カートに追加しました</h3><br><br>
         
         <div><img src="<%=PDB.getUrl()%>"width="300" height="200" border="0"></div>
         <div> <a href="Cart" class="btn btn-primary">カートを確認</a></div><br>
